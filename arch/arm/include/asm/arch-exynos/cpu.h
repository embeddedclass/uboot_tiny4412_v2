 ...
 * CLOCK
 */
#define ACLK_GDL_TYPE 0
#define ACLK_GPL_TYPE 1

#define ELFIN_CLOCK_BASE		0x10030000

#define CLK_SRC_LEFTBUS_OFFSET		0x04200
#define CLK_SRC_LEFTBUS_SAT_OFFSET 0x04400
...
#define LEFTBUS_CON0_REG __REG(ELFIN_CLOCK_BASE + CLK_SRC_LEFTBUS_OFFSET)
...
#define EXYNOS_ADC_BASE 0x126C0000
#endif
